...
class RelationGraph:
    ...
    co_occurrences = [{'left': 'blocked', 'right': 'goal', 'count': 11}, {'left': 'blocked', 'right': 'work', 'count': 11}, {'left': 'goal', 'right': 'work', 'count': 11}]
    hard_edges = [{'source': 0, 'target': 1, 'relation': 'follows_from', 'label': None}, {'source': 1, 'target': 2, 'relation': 'follows_from', 'label': None}, {'source': 2, 'target': 3, 'relation': 'follows_from', 'label': None}, {'source': 3, 'target': 4, 'relation': 'follows_from', 'label': None}, {'source': 4, 'target': 5, 'relation': 'follows_from', 'label': None}, {'source': 5, 'target': 6, 'relation': 'follows_from', 'label': None}, {'source': 6, 'target': 7, 'relation': 'follows_from', 'label': None}, {'source': 7, 'target': 8, 'relation': 'follows_from', 'label': None}, {'source': 8, 'target': 9, 'relation': 'follows_from', 'label': None}, {'source': 9, 'target': 10, 'relation': 'follows_from', 'label': None}]
