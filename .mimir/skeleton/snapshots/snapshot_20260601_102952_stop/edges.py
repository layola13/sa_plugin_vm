...
class RelationGraph:
    ...
    co_occurrences = [{'left': 'crash', 'right': 'goal', 'count': 2}, {'left': 'goal', 'right': 'work', 'count': 2}]
    hard_edges = [{'source': 0, 'target': 1, 'relation': 'follows_from', 'label': None}, {'source': 1, 'target': 2, 'relation': 'follows_from', 'label': None}, {'source': 2, 'target': 3, 'relation': 'follows_from', 'label': None}, {'source': 6, 'target': 7, 'relation': 'follows_from', 'label': None}]
